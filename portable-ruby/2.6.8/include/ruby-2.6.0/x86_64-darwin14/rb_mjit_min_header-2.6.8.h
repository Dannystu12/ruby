...
FILE *fopen(const char * restrict, const char * restrict) __asm("_" "fopen" "$DARWIN_EXTSN");
...
{
    long lz = ((long)(((long)(x))>>(int)(1))) + ((long)(((long)(y))>>(int)(1)));
    ...
    VALUE * const locals, const enum arg_setup_type arg_setup_type)
{
 ...
 if (iseq->body->param.flags.has_kw) {
     ...
     args->kw_argv = ((VALUE*)__builtin_alloca(sizeof(VALUE)*(kw_len)));
     args->argc -= kw_len;
     given_argc -= kw_len;
 ...
 if (args->kw_argv != ((void*)0)) {
     ...
     arg.keys = args->kw_argv = ((VALUE*)__builtin_alloca(sizeof(VALUE)*(kw_len * 2)));
                          ...
                          const struct rb_call_info *ci, rb_iseq_t *blockiseq, const int is_super)
{
 ...
 if (!((VALUE)(block_code) != ((VALUE)RUBY_Qnil))) {
  ...
  if (!((VALUE)(func) != ((VALUE)RUBY_Qnil))) {
                    ...
                    do { const VALUE _ary = (callback_arg); const VALUE _v = (block_code); VALUE *ptr = (VALUE *)rb_array_ptr_use_start(_ary, 1); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[0]), (VALUE)(_v), "./vm_args.c", 892); rb_array_ptr_use_end(_ary, 1); } while (0);
                    do { const VALUE _ary = (callback_arg); const VALUE _v = (ref); VALUE *ptr = (VALUE *)rb_array_ptr_use_start(_ary, 1); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[1]), (VALUE)(_v), "./vm_args.c", 893); rb_array_ptr_use_end(_ary, 1); } while (0);
...
vm_call_bmethod(rb_execution_context_t *ec, rb_control_frame_t *cfp, struct rb_calling_info *calling, const struct rb_call_info *ci, struct rb_call_cache *cc)
{
    ...
    do { if ((__builtin_expect(!!(((ci)->flag & (0x01 << VM_CALL_ARGS_SPLAT_bit))), 0))) vm_caller_setup_arg_splat((cfp), (calling)); if ((__builtin_expect(!!(((ci)->flag & (0x01 << VM_CALL_KWARG_bit))), 0))) vm_caller_setup_arg_kw((cfp), (calling), (ci)); } while (0);
    argc = calling->argc;
    argv = ((VALUE*)__builtin_alloca(sizeof(VALUE)*(argc)));
...
#define RUBY_PLATFORM "x86_64-darwin14"
...
#define __MAC_OS_X_VERSION_MAX_ALLOWED __MAC_10_10_3
