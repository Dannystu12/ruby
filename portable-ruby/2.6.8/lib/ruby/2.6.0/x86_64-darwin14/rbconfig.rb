...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/x86_64-darwin14")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/2.6.8")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/Cellar/portable-ruby/2.6.8' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=tk,sdbm,gdbm,dbm' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' 'MJIT_CC=/usr/bin/clang' '--with-opt-dir=/usr/local/opt/portable-readline:/usr/local/opt/portable-libyaml:/usr/local/opt/portable-openssl' 'CC=clang' 'LDFLAGS=-Wl,-search_paths_first' 'CXX=clang++'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-search_paths_first -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/portable-libyaml/lib -L/usr/local/opt/portable-openssl/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["RANLIB"] = ":"
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple LLVM version 7.0.2 (clang-700.1.81)\nTarget: x86_64-apple-darwin14.5.0\nThread model: posix"
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "/usr/bin/clang"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -I/usr/local/opt/portable-readline/include -I/usr/local/opt/portable-libyaml/include -I/usr/local/opt/portable-openssl/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-search_paths_first -fstack-protector-strong -L/usr/local/lib -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/portable-libyaml/lib -L/usr/local/opt/portable-openssl/lib"
  CONFIG["CFLAGS"] = "$(cflags)  -pipe"
  CONFIG["CC"] = "clang"
  CONFIG["target_os"] = "darwin14"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin14"
  CONFIG["host_os"] = "darwin14.5.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin14.5.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin14.5.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin14.5.0"
